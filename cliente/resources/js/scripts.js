...
var settings = {
	...
	bodyBackgroundImagePath: 'resources/img/background-2.jpg', // path to the background image
	twitterWidgetId: '355933225069187074' // your Twitter widget ID (see the documentation)
}

//var skin = "gold";
var skin = "silver";
if (window.location.hash && window.location.hash.substr(1, 4) == 'skin') {
	skin = window.location.hash.substr(6);
}

var imgno = 1;
if (skin != '') {
	if (skin == 'gold') imgno = 1;
	else if (skin == 'silver') imgno = 2;
	else if (skin == 'blue') imgno = 3;
	else if (skin == 'red') imgno = 4;
	else if (skin == 'green') imgno = 5;
	else if (skin == 'brown') imgno = 6;
	else if (skin == 'lightblue') imgno = 7;
	else if (skin == 'white') imgno = 8;
}
...
/* ==========================================================================
   ...
   ========================================================================== */
	...
	if (settings.bodyBackgroundImage) {
		$.backstretch([
			'resources/img/background-'+imgno+'.jpg',
			'resources/img/background-1.jpg',
			'resources/img/background-2.jpg',
			'resources/img/background-3.jpg',
			'resources/img/background-4.jpg',
			'resources/img/background-5.jpg',
			'resources/img/background-6.jpg',
			'resources/img/background-7.jpg',
			'resources/img/background-8.jpg'
		], {
			centeredY: false,
			fade: 500,
			duration: 9999999
...
/* ==========================================================================
   ...
   ========================================================================== */
	...
	var initContact = function() {
		...
		$('#contact-form').append('<div class="loader hidden">Sendingâ€¦</div>').submit(function(e) {
			var $form = $(this);
		...
		$('#postcard form').submit(function(e) {
			...
			e.preventDefault();
		}).parent().parent().parent().append('<div class="loader hidden">Sendingâ€¦</div>')
...
/* ==========================================================================
   ...
   ========================================================================== */
	...
	// demo
	$('head').append('<link rel="stylesheet" href="resources/css/style-switcher.css">');
	var $styleSwitcher = $('<div id="style-switcher" style="display: none"/>');
	var $skinLink = $('<link rel="stylesheet" href="resources/css/skin-'+skin+'.css">');
	$('head').append($skinLink);
	$styleSwitcher.append('<h2>Style switcher <span></span></h2><div class="options"><h3>Color Theme</h3><ul class="colors"><li class="gold" data-skin="gold"><span></span></li><li class="silver" data-skin="silver"><span></span></li><li class="blue" data-skin="blue"><span></span></li><li class="red" data-skin="red"><span></span></li><li class="green" data-skin="green"><span></span></li><li class="brown" data-skin="brown"><span></span></li><li class="lightblue" data-skin="lightblue"><span></span></li><li class="white" data-skin="white"><span></span></li></ul><h3>Page Transition</h3><ul class="transitions"><li>fade</li><li>scale</li><li class="active">scroll vertical</li><li>scroll horizontal</li></ul></div>').appendTo($body);
	$styleSwitcher.find('.colors li.'+skin).addClass('active');
	setTimeout(function() {
		$styleSwitcher.show();
	}, 1000);
	$styleSwitcher.find('h2 span').click(function() {
		$styleSwitcher.toggleClass('visible');
	});
	$styleSwitcher.find('.colors li').click(function() {
		$(this).addClass('active').siblings().removeClass('active');
		$.backstretch('show', $(this).index()+1);
		$skinLink.attr({ href: 'resources/css/skin-'+$(this).data('skin')+'.css' });
	});
	$styleSwitcher.find('.transitions li').click(function() {
		$(this).addClass('active').siblings().removeClass('active');
		$('body').attr('data-page-transition', $(this).text().replace(' ', '-'));
	});
